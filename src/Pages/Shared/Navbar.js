        ...
        <div>
            <div class="navbar bg-info">
                <div class="navbar-start">
                    ...
                    <a class="btn btn-ghost normal-case text-white text-2xl">Product Management</a>
                </div>
                <div class="navbar-center hidden text-2xl text-white lg:flex">
                    {/* <ul class="menu menu-horizontal p-0">
                        {menuItems}
                    </ul> */}
                </div>
                <div class="navbar-end  text-2xl text-white">
